...
${warningMsg}
Твоя задача: Провести мульти-ролевой аудит локации и вынести финальный вердикт.
...
ВАЖНО: Никаких галлюцинаций. Если данных мало (например, OSM не вернул конкурентов), так и напиши: "Недостаточно данных для гарантии успеха, требуется полевой выезд". Не додумывай трафик там, где его нет.

Формат вывода в JSON поле "executive_summary":
"Сжатый текст (3-4 предложения). Четкий вывод. Рекомендация к действию."
---
