...
### STRICT EVIDENCE RULES (ОБЯЗАТЕЛЬНО К ИСПОЛНЕНИЮ):
1. ЗАПРЕТ "ВОДЫ": Запрещено использовать прилагательные "высокий", "хороший", "много", "развитый" БЕЗ указания конкретной цифры.
   - ПЛОХО: "Высокий пешеходный трафик и развитая инфраструктура".
   - ХОРОШО: "Высокий трафик, обеспеченный 12 автобусными остановками и 1 станцией метро в радиусе 100м".
   - ПЛОХО: "Платежеспособная аудитория".
   - ХОРОШО: "Высокая плотность коммерции (8 офисных центров, 2 банка) указывает на наличие платежеспособного офисного трафика".

2. USE RAW JSON DATA:
   - Ты ОБЯЗАН смотреть в блок RAW JSON DATA (в конце промпта).
   - Извлекай точные значения: transport.bus_stops, population, competitors.length, apartments.count.
   - Если пишешь про конкурентов, укажи: "5 конкурентов (вкл. KFC, Burger King)".
   - Если пишешь про жилье, укажи: "24 жилых дома в радиусе 300м".
...
### STRICT EVIDENCE RULES (EVIDENCE-BASED LOGIC):
1. NO VAGUE ADJECTIVES: Never say "good location" without citing data.
   - BAD: "Many competitors nearby."
   - GOOD: "High competition density: 7 fast-food outlets within 200m."
2. USE RAW JSON: Always cite numbers from the JSON provided (population, footways, offices).
